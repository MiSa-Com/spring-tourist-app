...
public class WeatherController {
    ...
    public ResponseEntity<?> getWeatherById(@PathVariable(UrlConst.id)Long id) {
        ...
        List<WeatherDataOutput> output = weatherServiceImp.getWeatherForecastForAProvince(getWeatherDataInput);
    ...
    public ResponseEntity<?> getListWeather(@Valid GetListWeatherDataParameter parameter) {
        ...
        List<WeatherDataOutput> output = weatherServiceImp.getCurrentWeatherForAllProvince(input);
        return ResponseUtil.restSuccess(output);
    }
    ...
    public ResponseEntity<?> getWeatherLatLng(@Valid GetWeatherByCoordinateDataParameter parameter){
        ...
        List<WeatherDataOutput> output = weatherServiceImp.getWeatherForecastByCoordinate(input.getLon(), input.getLat());
        return ResponseUtil.restSuccess(output);
    }
}
